...
console.log("router",facilities)
    ...
    const mockdata = [
      ...
      const handleReservationSubmit = async () => {
        ...
        console.log([
          owner,name,date,numOfPeople
        ])
        try {
          // Make a POST request to your reservation endpoint with reservation details
          const response = await axios.post(
            `${url}/messagetoplaces`,
            {
              body: {
                ...
                // Add other reservation details based on your schema
                payload: {
                  TargetName: name,
                  NewInfo: {
                    AvailableSeat: availableSeats,
                    // Add other payload details based on your schema
                  },
                },
              },
    ...
    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
        <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <h3 className="text-base font-bold leading-6 text-gray-900" id="modal-title">Please fill the details</h3>
        ...
        <input
          ...
          className='ml-2 my-3 p-1 bg-gray-200 pl-2 rounded-md'
        /></div>
        <div>
        <label>Date: </label>
        <input
        ...
        <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button onClick={reserve} type="button" className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">
              confirm</button>
        </div>
      </div>
    </div>
...
{/* --------------------------modal----------------------- */}
        ...
        <div className="p-16">
            ...
            <div className="space-x-8 flex justify-between mt-32 md:mt-0 md:justify-center">
                ...
                <button onClick={toggleModal} className="text-white py-2 px-4 uppercase rounded bg-gray-700 hover:bg-gray-950 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"> 
                    Reserve
                </button>    
            </div>
        </div>  
