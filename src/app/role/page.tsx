      ...
      <div className="mt-20 flex min-h-full flex-1 flex-col justify-normal px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-3xl">
          ...
          <h3 className="w-[100%] mt-2 text-center text-base leading-9 tracking-tight text-white">
            Please choose between place's owner or user. Otherwise, you will not be able to
            create an account.
          </h3>
        </div>

        <div className="mt-8 flex justify-center">
        <button className="text-lg mt-4 block rounded-md bg-indigo-500 hover:bg-indigo-700 px-5 py-4 text-white shadow-sm"
